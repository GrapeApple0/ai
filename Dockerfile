...
RUN cat /opt/mecab-ipadic-neologd/libexec/make-mecab-ipadic-neologd.sh | sed "s/ja\.osdn/sourceforge/" | tee /opt/mecab-ipadic-neologd/libexec/make-mecab-ipadic-neologd.sh
